...
import { WhatsappConexaoController } from './whatsapp-conexao.controller';
import { ConversationService } from './conversation.service';
import { ConversationStateMachine } from './conversation-state-machine';
import { InboxService } from './inbox.service';
import { BaileysIngestService } from './baileys-ingest.service';
...
@Module({
  ...
  controllers: [WhatsappController, ConversasController, WhatsappConexaoController],
  providers: [
    ConversationService,
    ConversationStateMachine,
    InboxService,
    BaileysIngestService,
  ],
})
